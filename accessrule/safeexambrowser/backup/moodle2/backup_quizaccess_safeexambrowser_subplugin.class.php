...
require_once($CFG->dirroot . '/mod/finalquiz/backup/moodle2/backup_mod_finalquiz_access_subplugin.class.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_finalquizaccess_safeexambrowser_subplugin extends backup_mod_finalquiz_access_subplugin {

    /**
     * Stores the data related to the safeexambrowser finalquiz access rule settings for a particular finalquiz.
     *
    ...
    protected function define_finalquiz_subplugin_structure() {
        ...
        $subplugintablesettings = new backup_nested_element('finalquizaccess_safeexambrowser',
        ...
        $subplugintablesettings->set_source_table('finalquizaccess_safeexambrowser',
