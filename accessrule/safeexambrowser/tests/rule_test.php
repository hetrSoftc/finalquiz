...
class quizaccess_safeexambrowser_testcase extends basic_testcase {
    ...
    public function test_check_key_matches() {
        $exampleurl = 'https://example.com/moodle/mod/finalquiz/attempt.php?attemptid=123&page=4';
    ...
    public function test_check_key_does_not_match() {
        ...
        $otherurl = 'https://example.com/moodle/mod/finalquiz/attempt.php?attemptid=123&page=5';
    ...
    public function test_validate_keys_duplicate() {
        $keys = self::EXAMPLE_KEY . "\n" . self::EXAMPLE_KEY;
        $this->assertEquals(array(get_string('allowedbrowserkeysdistinct', 'finalquizaccess_safeexambrowser')),
    ...
    public function test_validate_keys_invalid_char() {
        ...
        $this->assertEquals(array(get_string('allowedbrowserkeyssyntax', 'finalquizaccess_safeexambrowser')),
            quizaccess_safeexambrowser::validate_keys($keys));
    }
    ...
    public function test_make_required() {
        ...
        $this->assertInstanceOf('finalquizaccess_safeexambrowser', $rule);
