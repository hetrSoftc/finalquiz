...
/**
 * Implementaton of the finalquizaccess_safebrowser plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class finalquizaccess_safebrowser extends finalquiz_access_rule_base {

    public static function make(finalquiz $quizobj, $timenow, $canignoretimelimits) {

        if ($quizobj->get_finalquiz()->browsersecurity !== 'safebrowser') {
            return null;
        }
    ...
    public function prevent_access() {
        if (!$this->check_safe_browser()) {
            return get_string('safebrowsererror', 'finalquizaccess_safebrowser');
        } else {
            return false;
        }
    }
    ...
    public function description() {
        return get_string('safebrowsernotice', 'finalquizaccess_safebrowser');
    }
    ...
    public static function get_browser_security_choices() {
        ...
        return array('safebrowser' =>
                get_string('requiresafeexambrowser', 'finalquizaccess_safebrowser'));
    }
}
