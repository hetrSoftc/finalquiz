...
/**
 * Unit tests for the finalquizaccess_ipaddress plugin.
 *
...
global $CFG;
require_once($CFG->dirroot . '/mod/finalquiz/accessrule/ipaddress/rule.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class finalquizaccess_ipaddress_testcase extends basic_testcase {
    public function test_ipaddress_access_rule() {
        ...
        if (!empty($quiz->subnet)) {
            ...
            $rule = new finalquizaccess_ipaddress($quizobj, 0);
