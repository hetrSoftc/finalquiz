 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class finalquizaccess_ipaddress extends finalquiz_access_rule_base {

    public static function make(finalquiz $quizobj, $timenow, $canignoretimelimits) {
        if (empty($quizobj->get_finalquiz()->subnet)) {
            return null;
        }
    ...
    public function prevent_access() {
        if (address_in_subnet(getremoteaddr(), $this->quiz->subnet)) {
            ...
            return get_string('subnetwrong', 'finalquizaccess_ipaddress');
        }
    }
}
