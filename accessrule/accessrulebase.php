...
abstract class quiz_access_rule_base {
     ...
     *
     * @param mod_finalquiz_preflight_check_form $quizform the form being built.
     ...
     * @param mod_finalquiz_mod_form $quizform the quiz settings form that is being built.
     * @param MoodleQuickForm $mform the wrapped MoodleQuickForm.
     */
     ...
     * @param mod_finalquiz_mod_form $quizform the finalquiz form object.
    ...
    /**
     * @return array key => lang string any choices to add to the final quiz Browser
    ...
    /**
     * Save any submitted settings when the final quiz settings form is submitted. This
     * is called from {@link finalquiz_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the final quiz is deleted. This is called
     * from {@link finalquiz_delete_instance()} in lib.php.
     * @param object $quiz the data from the database, including $quiz->id
     *      which is the id of the final quiz being deleted.
     ...
     * here is probalby to read the code of {@link finalquiz_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $quizid the id of the finalquiz we are loading settings for. This
     *     can also be accessed as finalquiz.id in the SQL. (finalquiz is a table alisas for {finalquiz}.)
     ...
     * @param int $quizid the finalquiz id.
