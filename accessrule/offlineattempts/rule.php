...
/**
 * Implementaton of the finalquizaccess_offlineattempts plugin.
 *
 * @package    finalquizaccess_offlineattempts
 ...
 * @since      Moodle 3.2
 */
class finalquizaccess_offlineattempts extends finalquiz_access_rule_base {
    ...
    public static function make(finalquiz $quizobj, $timenow, $canignoretimelimits) {
        ...
        if (empty($CFG->enablemobilewebservice) or empty($quizobj->get_finalquiz()->allowofflineattempts)) {
            return null;
        }
    ...
    public function is_preflight_check_required($attemptid) {
        ...
        if (!empty($attemptid)) {
            $timemodifiedoffline = $DB->get_field('finalfinalquiz_attempts', 'timemodifiedoffline', array('id' => $attemptid));
    ...
    public function add_preflight_check_form_fields(mod_finalquiz_preflight_check_form $quizform,
        ...
        $mform->addElement('header', 'offlineattemptsheader', get_string('mobileapp', 'finalquizaccess_offlineattempts'));
        $mform->addElement('static', 'offlinedatamessage', '',
                get_string('offlinedatamessage', 'finalquizaccess_offlineattempts', $lasttime));
        $mform->addElement('advcheckbox', 'confirmdatasaved', null,
                get_string('confirmdatasaved', 'finalquizaccess_offlineattempts'));
    }
    ...
    public function validate_preflight_check($data, $files, $errors, $attemptid) {
        ...
        $errors['confirmdatasaved'] = get_string('pleaseconfirm', 'finalquizaccess_offlineattempts');
        return $errors;
    }
    ...
    public static function add_settings_form_fields(
        ...
        if ($CFG->enablemobilewebservice) {
            $mform->addElement('selectyesno', 'allowofflineattempts',
                                get_string('allowofflineattempts', 'finalquizaccess_offlineattempts'));
            $mform->addHelpButton('allowofflineattempts', 'allowofflineattempts', 'finalquizaccess_offlineattempts');
    ...
    public static function validate_settings_form_fields(array $errors,
        ...
        if ($CFG->enablemobilewebservice) {
            ...
            if (!empty($data['allowofflineattempts']) and
                ...
                $errors['allowofflineattempts'] = get_string('offlineattemptserror', 'finalquizaccess_offlineattempts');
            }
        }
