 ...
 *
 * @module     mod_finalquiz/modal_add_random_question
...
function(
    ...
    ModalAddRandomQuestion.TYPE = 'mod_finalquiz-quiz-add-random-question';
    ...
    if (!registered) {
        ModalRegistry.register(
            ...
            'mod_finalquiz/modal_add_random_question'
        );
