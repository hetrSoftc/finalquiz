 ...
 *
 * @module     mod_finalquiz/modal_finalquiz_question_bank
...
function(
    ...
    var SELECTORS = {
        ADD_TO_finalquiz_CONTAINER: 'td.addtoquizaction',
        ANCHOR: 'a[href]',
    ...
    ModalQuizQuestionBank.TYPE = 'mod_finalquiz-quiz-question-bank';
    ...
    ModalQuizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            if (anchorElement.closest(SELECTORS.ADD_TO_finalquiz_CONTAINER).length) {
