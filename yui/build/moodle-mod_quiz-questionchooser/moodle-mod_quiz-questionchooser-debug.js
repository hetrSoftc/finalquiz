YUI.add('moodle-mod_finalquiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_finalquiz-questionchooser'
});

M.mod_finalquiz = M.mod_finalquiz || {};
M.mod_finalquiz.init_questionchooser = function() {
    M.mod_finalquiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_finalquiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_finalquiz-util", "querystring-parse"]});
