YUI.add('moodle-mod_finalquiz-quizbase', function (Y, NAME) {

/**
 * The quizbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_finalquiz-quizbase
 */
var QUIZBASENAME = 'mod_finalquiz-quizbase';
...
M.mod_finalquiz.quizbase = M.mod_finalquiz.quizbase || new QUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_finalquiz.edit = M.mod_finalquiz.edit || {};
 ...
 */
M.mod_finalquiz.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_finalquiz.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
