...
namespace mod_finalquiz\question\bank;
...
class custom_view extends \core_question\bank\view {
    ...
    protected function wanted_columns() {
        ...
        foreach ($quizquestionbankcolumns as $fullname) {
            if (!class_exists($fullname)) {
                if (class_exists('mod_finalquiz\\question\\bank\\' . $fullname)) {
                    $fullname = 'mod_finalquiz\\question\\bank\\' . $fullname;
                    ...
                    debugging('Legacy question bank column class question_bank_' .
                            $fullname . ' should be renamed to mod_finalquiz\\question\\bank\\' .
    ...
    protected function heading_column() {
        return 'mod_finalquiz\\question\\bank\\question_name_text_column';
    }

    protected function default_sort() {
        return array(
            'core_question\\bank\\question_type_column' => 1,
            'mod_finalquiz\\question\\bank\\question_name_text_column' => 1,
        );
    }
     ...
     */
    public function set_finalquiz_has_attempts($quizhasattempts) {
    ...
    public function add_to_finalquiz_url($questionid) {
        global $CFG;
        $params = $this->baseurl->params();
        $params['addquestion'] = $questionid;
        $params['sesskey'] = sesskey();
        return new \moodle_url('/mod/finalquiz/edit.php', $params);
    }
    ...
    protected function display_bottom_controls($totalnumber, $recurse, $category, \context $catcontext, array $addcontexts) {
        ...
        if ($canuseall) {
            ...
            $params = array(
                    ...
                    'value' => get_string('addselectedquestionstoquiz', 'finalquiz'),
            );
    ...
    protected function display_options_form($showquestiontext, $scriptpath = '/mod/finalquiz/edit.php',
    ...
    protected function print_category_info($category) {
        ...
        $strcategory = get_string('category', 'finalquiz');
