...
/**
 * The mod_finalquiz question manually graded event.
 *
 * @package    core
...
/**
 * The mod_finalquiz question manually graded event class.
 *
...
class question_manually_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestionmanuallygraded', 'mod_finalquiz');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/finalquiz/comment.php', array('attempt' => $this->other['attemptid'],
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'finalquiz', 'manualgrade', 'comment.php?attempt=' . $this->other['attemptid'] .
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['attemptid'] = array('db' => 'finalquiz_attempts', 'restore' => 'finalquiz_attempt');
