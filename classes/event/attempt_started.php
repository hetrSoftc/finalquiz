...
/**
 * The mod_finalquiz attempt started event.
 *
 * @package    mod_finalquiz
 * @copyright  2013 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace mod_finalquiz\event;
defined('MOODLE_INTERNAL') || die();

/**
 * The mod_finalquiz attempt started event class.
 *
...
class attempt_started extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'finalquiz_attempts';
        $this->data['crud'] = 'c';
    ...
    public static function get_name() {
        return get_string('eventquizattemptstarted', 'mod_finalquiz');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/finalquiz/review.php', array('attempt' => $this->objectid));
    }
    ...
    protected function get_legacy_eventdata() {
        $attempt = $this->get_record_snapshot('finalquiz_attempts', $this->objectid);

        $legacyeventdata = new \stdClass();
        $legacyeventdata->component = 'mod_finalquiz';
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'finalquiz', 'attempt', 'review.php?attempt=' . $this->objectid,
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'finalquiz_attempts', 'restore' => 'finalquiz_attempt');
    }

    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['quizid'] = array('db' => 'finalquiz', 'restore' => 'finalquiz');
