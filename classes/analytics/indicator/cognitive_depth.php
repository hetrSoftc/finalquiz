...
namespace mod_finalquiz\analytics\indicator;
...
class cognitive_depth extends activity_base {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:cognitivedepth', 'mod_finalquiz');
    }
    ...
    protected function feedback_submitted_events() {
        return array('\mod_finalquiz\event\attempt_submitted');
    }
