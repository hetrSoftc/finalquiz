...
/**
 * Admin settings class for the finalquiz review options.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_finalquiz_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_finalquiz_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_finalquiz_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'finalquiz'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'finalquiz'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'finalquiz'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'finalquiz'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'finalquiz'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'finalquiz'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'finalquiz'), $query);
    }
}
