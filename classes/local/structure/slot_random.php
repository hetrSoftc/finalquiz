...
/**
 * Defines the \mod_finalquiz\local\structure\slot_random class.
 *
...
namespace mod_finalquiz\local\structure;
...
class slot_random {
    ...
    public function get_quiz() {
        ...
        if (empty($this->quiz)) {
            ...
            $this->quiz = $DB->get_record('finalquiz', array('id' => $this->record->quizid));
        }
