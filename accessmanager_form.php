...
/**
 * A form that limits student's access to attempt a final quiz.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_finalquiz_preflight_check_form extends moodleform {

    protected function definition() {
        $mform = $this->_form;
        $this->_form->updateAttributes(array('id' => 'mod_finalquiz_preflight_form'));
        ...
        $this->add_action_buttons(true, get_string('startattempt', 'finalquiz'));
