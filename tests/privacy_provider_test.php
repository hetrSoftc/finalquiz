...
use mod_finalquiz\privacy\provider;
use mod_finalquiz\privacy\helper;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_finalquiz_privacy_provider_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_user_with_data() {
        ...
        $this->assertEquals($quizobj->get_finalquiz_name(), $quizdata->name);
        ...
        $attemptsubcontext = [
            get_string('attempts', 'mod_finalquiz'),
            $attempt->attempt,
        ];
        ...
        $attemptsubcontext = helper::get_finalquiz_attempt_subcontext($attemptobj->get_attempt(), $user);
