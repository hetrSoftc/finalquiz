 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_finalquiz_restore_date_testcase extends restore_date_testcase
{
    ...
    public function test_restore_dates() {
        ...
        list($course, $quiz) = $this->create_course_and_module('finalquiz', $record);
        ...
        $DB->set_field('finalquiz_attempts', 'timefinish', $timestamp);

        // Do backup and restore.
        $newcourseid = $this->backup_and_restore($course);
        $newquiz = $DB->get_record('finalquiz', ['course' => $newcourseid]);
        ...
        $newattempt = $DB->get_record('finalquiz_attempts', ['finalquiz' => $newquiz->id]);
        $newoverride = $DB->get_record('quiz_overrides', ['finalquiz' => $newquiz->id]);
        $newgrade = $DB->get_record('quiz_grades', ['finalquiz' => $newquiz->id]);
