 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_finalquiz_locallib_testcase extends advanced_testcase {

    public function test_finalquiz_rescale_grade() {
        $quiz = new stdClass();
    ...
    public function quiz_attempt_state_data_provider() {
        return [
            [quiz_attempt::IN_PROGRESS, null, null, mod_finalquiz_display_options::DURING],
            [quiz_attempt::FINISHED, -90, null, mod_finalquiz_display_options::IMMEDIATELY_AFTER],
            [quiz_attempt::FINISHED, -7200, null, mod_finalquiz_display_options::LATER_WHILE_OPEN],
            [quiz_attempt::FINISHED, -7200, 3600, mod_finalquiz_display_options::LATER_WHILE_OPEN],
            [quiz_attempt::FINISHED, -30, 30, mod_finalquiz_display_options::IMMEDIATELY_AFTER],
            [quiz_attempt::FINISHED, -90, -30, mod_finalquiz_display_options::AFTER_CLOSE],
            [quiz_attempt::FINISHED, -7200, -3600, mod_finalquiz_display_options::AFTER_CLOSE],
            [quiz_attempt::FINISHED, -90, -3600, mod_finalquiz_display_options::AFTER_CLOSE],
            [quiz_attempt::ABANDONED, -10000000, null, mod_finalquiz_display_options::LATER_WHILE_OPEN],
            [quiz_attempt::ABANDONED, -7200, 3600, mod_finalquiz_display_options::LATER_WHILE_OPEN],
            [quiz_attempt::ABANDONED, -7200, -3600, mod_finalquiz_display_options::AFTER_CLOSE],
        ];
    }
     ...
     *
     * @param unknown $attemptstate as in the finalquiz_attempts.state DB column.
     ...
     * @param unknown $expectedstate expected result. One of the mod_finalquiz_display_options constants/
     */
    public function test_finalquiz_attempt_state($attemptstate,
    ...
    public function test_finalquiz_question_tostring() {
     ...
     * @return void
     */
    public function test_finalquiz_view() {
        global $CFG;
        ...
        $moodleurl = new \moodle_url('/mod/finalquiz/view.php', array('id' => $cm->id));
     ...
     */
    public function test_finalquiz_is_overriden_calendar_event_no_override() {
        global $CFG, $DB;
        ...
        $quizgenerator = $generator->get_plugin_generator('mod_finalquiz');
        $quiz = $quizgenerator->create_instance(['course' => $course->id]);

        $event = new \calendar_event((object)[
            'modulename' => 'finalquiz',
            'instance' => $quiz->id,
            'userid' => $user->id
        ]);
     ...
     */
    public function test_finalquiz_is_overriden_calendar_event_no_module_event() {
        global $CFG, $DB;
     ...
     * instance.
     */
    public function test_finalquiz_is_overriden_calendar_event_different_finalquiz_instance() {
        global $CFG, $DB;
     ...
     */
    public function test_finalquiz_is_overriden_calendar_event_user_override() {
        global $CFG, $DB;
     ...
     */
    public function test_finalquiz_is_overriden_calendar_event_group_override() {
        global $CFG, $DB;
    ...
    /**
     * Test test_finalquiz_get_user_timeclose().
     */
    public function test_finalquiz_get_user_timeclose() {
        global $DB;
     ...
     */
    private function setup_finalquiz_and_tags($qnum, $randomqnum, $questiontags = [], $unusedtags = []) {
        global $SITE;
    ...
    public function test_finalquiz_retrieve_slot_tags() {
        global $DB;
    ...
    public function test_finalquiz_retrieve_slot_tags_with_removed_tag() {
        global $DB;
    ...
    public function test_finalquiz_retrieve_slot_tags_for_standard_question() {
        global $DB;
    ...
    public function test_finalquiz_retrieve_slot_tag_ids() {
        global $DB;
    ...
    public function test_finalquiz_retrieve_slot_tag_ids_for_standard_question() {
        global $DB;
     ...
     */
    public function get_finalquiz_retrieve_tags_for_slot_ids_test_cases() {
        return [
            'no questions' => [
                'questioncount' => 0,
     ...
     * combinations.
     *
     * @dataProvider get_finalquiz_retrieve_tags_for_slot_ids_test_cases()
     ...
     */
    public function test_finalquiz_retrieve_tags_for_slot_ids_combinations(
        $questioncount,
        $randomquestioncount,
        $randomquestiontags,
        $unusedtags,
        ...
        list($quiz, $tags) = $this->setup_finalquiz_and_tags(
            $questioncount,
            $randomquestioncount,
            $randomquestiontags,
            $unusedtags
