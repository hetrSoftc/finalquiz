 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_finalquiz_attempt_walkthrough_testcase extends advanced_testcase {

    /**
     * Create a quiz with questions and walk through a quiz attempt.
     */
    public function test_finalquiz_attempt_walkthrough() {
        global $SITE;
        ...
        // Check grade book.
        $gradebookgrades = grade_get_grades($SITE->id, 'mod', 'finalquiz', $quiz->id, $user1->id);
     ...
     */
    public function test_finalquiz_with_random_question_attempt_walkthrough() {
        global $SITE;
     ...
     */
    public function test_finalquiz_with_question_with_variants_attempt_walkthrough($variantno, $correctresponse, $done = false) {
        global $SITE;
        ...
        if ($this->quizwithvariants === null) {
            ...
            quiz_add_finalquiz_question($calc->id, $this->quizwithvariants, 0);
        }
        ...
        // Check grade book.
        $gradebookgrades = grade_get_grades($SITE->id, 'mod', 'finalquiz', $this->quizwithvariants->id, $user1->id);
        $gradebookitem = array_shift($gradebookgrades->items);
        $gradebookgrade = array_shift($gradebookitem->grades);
        $this->assertEquals(100, $gradebookgrade->grade);
    }
