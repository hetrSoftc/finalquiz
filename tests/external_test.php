...
/**
 * Silly class to access mod_finalquiz_external internal methods.
 *
 * @package mod_finalquiz
 * @copyright 2016 Juan Leyva <juan@moodle.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since  Moodle 3.1
 */
class testable_mod_finalquiz_external extends mod_finalquiz_external {
 ...
 * @since      Moodle 3.1
 */
class mod_finalquiz_external_testcase extends externallib_advanced_testcase {
    ...
    public function setUp() {
        ...
        $this->quiz = $this->getDataGenerator()->create_module('finalquiz', array('course' => $this->course->id));
        $this->context = context_module::instance($this->quiz->cmid);
        $this->cm = get_coursemodule_from_instance('finalquiz', $this->quiz->id);
     ...
     */
    private function create_finalquiz_with_questions($startattempt = false, $finishattempt = false, $behaviour = 'deferredfeedback') {

        // Create a new quiz with attempts.
        $quizgenerator = $this->getDataGenerator()->get_plugin_generator('mod_finalquiz');
        ...
        quiz_add_finalquiz_question($question->id, $quiz);
        $question = $questiongenerator->create_question('numerical', null, array('category' => $cat->id));
        quiz_add_finalquiz_question($question->id, $quiz);
        ...
        $item = grade_item::fetch(array('courseid' => $this->course->id, 'itemtype' => 'mod',
                                        'itemmodule' => 'finalquiz', 'iteminstance' => $quiz->id, 'outcomeid' => null));
        $item->gradepass = 80;
        $item->update();
    ...
    public function test_mod_finalquiz_get_finalquizzes_by_courses() {
        ...
        $quiz2 = self::getDataGenerator()->create_module('finalquiz', $record);
        ...
        $quiz1->hasfeedback = 0;
        $quiz1->autosaveperiod = get_config('finalquiz', 'autosaveperiod');
        $quiz1->introfiles = [];
        ...
        $quiz2->hasfeedback = 0;
        $quiz2->autosaveperiod = get_config('finalquiz', 'autosaveperiod');
        $quiz2->introfiles = [];
    ...
    public function test_view_quiz() {
        ...
        try {
            mod_finalquiz_external::view_quiz(0);
            $this->fail('Exception expected due to invalid mod_finalquiz instance id.');
        ...
        try {
            mod_finalquiz_external::view_quiz($this->quiz->id);
        ...
        $result = mod_finalquiz_external::view_quiz($this->quiz->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::view_finalquiz_returns(), $result);
        ...
        $this->assertInstanceOf('\mod_finalquiz\event\course_module_viewed', $event);
        $this->assertEquals($this->context, $event->get_context());
        $moodlequiz = new \moodle_url('/mod/finalquiz/view.php', array('id' => $this->cm->id));
        ...
        assign_capability('mod/finalquiz:view', CAP_PROHIBIT, $this->studentrole->id, $this->context->id);
    ...
    public function test_get_user_attempts() {
        ...
        list($quiz, $context, $quizobj, $attempt, $attemptobj) = $this->create_finalquiz_with_questions(true, true);

        $this->setUser($this->student);
        $result = mod_finalquiz_external::get_user_attempts($quiz->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_user_attempts_returns(), $result);

        $this->assertCount(1, $result['attempts']);
        $this->assertEquals($attempt->id, $result['attempts'][0]['id']);
        $this->assertEquals($quiz->id, $result['attempts'][0]['finalquiz']);
        ...
        $result = mod_finalquiz_external::get_user_attempts($quiz->id, 0, 'finished', false);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_user_attempts_returns(), $result);
        ...
        $result = mod_finalquiz_external::get_user_attempts($quiz->id, 0, 'all', false);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_user_attempts_returns(), $result);
        ...
        $result = mod_finalquiz_external::get_user_attempts($quiz->id, 0, 'unfinished', false);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_user_attempts_returns(), $result);
        ...
        $result = mod_finalquiz_external::get_user_attempts($quiz->id, $this->student->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_user_attempts_returns(), $result);

        $this->assertCount(1, $result['attempts']);
        $this->assertEquals($this->student->id, $result['attempts'][0]['userid']);

        $result = mod_finalquiz_external::get_user_attempts($quiz->id, $this->student->id, 'all');
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_user_attempts_returns(), $result);
        ...
        // Invalid parameters.
        try {
            mod_finalquiz_external::get_user_attempts($quiz->id, $this->student->id, 'INVALID_PARAMETER');
            $this->fail('Exception expected due to missing capability.');
    ...
    public function test_get_user_best_grade() {
        ...
        $result = mod_finalquiz_external::get_user_best_grade($this->quiz->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_user_best_grade_returns(), $result);
        ...
        try {
            mod_finalquiz_external::get_user_best_grade($this->quiz->id, $anotherstudent->id);
            $this->fail('Exception expected due to missing capability.');
        ...
        $result = mod_finalquiz_external::get_user_best_grade($this->quiz->id, $this->student->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_user_best_grade_returns(), $result);
        ...
        // Invalid user.
        try {
            mod_finalquiz_external::get_user_best_grade($this->quiz->id, -1);
            $this->fail('Exception expected due to missing capability.');
     ...
     * This is a basic test, this is already tested in final_testcase.
     */
    public function test_get_combined_review_options() {
        ...
        $result = mod_finalquiz_external::get_combined_review_options($quiz->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_combined_review_options_returns(), $result);
        ...
        $result = mod_finalquiz_external::get_combined_review_options($quiz->id, $this->student->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_combined_review_options_returns(), $result);
        ...
        // Invalid user.
        try {
            mod_finalquiz_external::get_combined_review_options($quiz->id, -1);
            $this->fail('Exception expected due to missing capability.');
        } catch (dml_missing_record_exception $e) {
            $this->assertEquals('invaliduser', $e->errorcode);
        }
    ...
    public function test_start_attempt() {
        ...
        list($quiz, $context, $quizobj) = $this->create_finalquiz_with_questions();
        ...
        $result = mod_finalquiz_external::start_attempt($quiz->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::start_attempt_returns(), $result);
        ...
        try {
            mod_finalquiz_external::start_attempt($quiz->id, array(array("name" => "quizpassword", "value" => 'bad')));
            $this->fail('Exception expected due to invalid passwod.');
        } catch (moodle_exception $e) {
            $this->assertEquals(get_string('passworderror', 'finalquizaccess_password'), $e->errorcode);
        }

        // Now, try everything correct.
        $result = mod_finalquiz_external::start_attempt($quiz->id, array(array("name" => "quizpassword", "value" => 'abc')));
        $result = external_api::clean_returnvalue(mod_finalquiz_external::start_attempt_returns(), $result);

        $this->assertEquals(1, $result['attempt']['attempt']);
        $this->assertEquals($this->student->id, $result['attempt']['userid']);
        $this->assertEquals($quiz->id, $result['attempt']['finalquiz']);
        $this->assertCount(0, $result['warnings']);
        ...
        try {
            mod_finalquiz_external::start_attempt($quiz->id, array(array("name" => "quizpassword", "value" => 'abc')));
            $this->fail('Exception expected due to attempt not finished.');
        } catch (moodle_finalquiz_exception $e) {
        ...
        // Test user with no capabilities.
        // We need a explicit prohibit since this capability is only defined in authenticated user and guest roles.
        assign_capability('mod/finalquiz:attempt', CAP_PROHIBIT, $this->studentrole->id, $context->id);
        // Empty all the caches that may be affected  by this change.
        accesslib_clear_all_caches_for_unit_testing();
        course_modinfo::clear_instance_cache();

        try {
            mod_finalquiz_external::start_attempt($quiz->id);
            $this->fail('Exception expected due to missing capability.');
        } catch (required_capability_exception $e) {
            $this->assertEquals('nopermissions', $e->errorcode);
        }
    ...
    public function test_validate_attempt() {
        ...
        list($quiz, $context, $quizobj, $attempt, $attemptobj) = $this->create_finalquiz_with_questions(true);
        ...
        try {
            ...
            testable_mod_finalquiz_external::validate_attempt($params);
        ...
        $result = testable_mod_finalquiz_external::validate_attempt($params);
        ...
        testable_mod_finalquiz_external::validate_attempt($params, false);
    ...
    public function test_get_attempt_data() {
        ...
        $DB->set_field('finalquiz', 'reviewcorrectness', mod_finalquiz_display_options::IMMEDIATELY_AFTER, array('id' => $quiz->id));

        $quizobj = $attemptobj->get_finalquizobj();
        ...
        $result = mod_finalquiz_external::get_attempt_data($attempt->id, 0);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_attempt_data_returns(), $result);
        ...
        $result = mod_finalquiz_external::get_attempt_data($attempt->id, 1);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_attempt_data_returns(), $result);
        ...
        $result = mod_finalquiz_external::get_attempt_review($attempt->id, 1);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_attempt_review_returns(), $result);
    ...
    public function test_get_attempt_data_with_blocked_questions() {
        ...
        list($quiz, $context, $quizobj, $attempt, $attemptobj) = $this->create_finalquiz_with_questions(
    ...
    public function test_get_attempt_summary() {
        ...
        $this->setUser($this->student);
        $result = mod_finalquiz_external::get_attempt_summary($attempt->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_attempt_summary_returns(), $result);
    ...
    public function test_save_attempt() {
        ...
        $timenow = time();
        // Create a new quiz with one attempt started.
        list($quiz, $context, $quizobj, $attempt, $attemptobj, $quba) = $this->create_finalquiz_with_questions(true);
        ...
        $result = mod_finalquiz_external::save_attempt($attempt->id, $data);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::save_attempt_returns(), $result);
        $this->assertTrue($result['status']);
    ...
    public function test_process_attempt() {
        ...
        $result = mod_finalquiz_external::process_attempt($attempt->id, $data);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::process_attempt_returns(), $result);
        ...
        // Finish the attempt.
        $result = mod_finalquiz_external::process_attempt($attempt->id, array(), true);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::process_attempt_returns(), $result);
        ...
        $result = mod_finalquiz_external::process_attempt($attempt->id, array());
        $result = external_api::clean_returnvalue(mod_finalquiz_external::process_attempt_returns(), $result);
    ...
    public function test_validate_attempt_review() {
        ...
        try {
            ...
            testable_mod_finalquiz_external::validate_attempt_review($params);
    ...
    public function test_get_attempt_review() {
        ...
        list($quiz, $context, $quizobj, $attempt, $attemptobj, $quba) = $this->create_finalquiz_with_questions(true, true);
        ...
        $result = mod_finalquiz_external::get_attempt_review($attempt->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_attempt_review_returns(), $result);
        ...
        // Only first page.
        $result = mod_finalquiz_external::get_attempt_review($attempt->id, 0);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_attempt_review_returns(), $result);
    ...
    public function test_view_attempt() {
        ...
        // Create a new quiz with two questions and one attempt started.
        list($quiz, $context, $quizobj, $attempt, $attemptobj, $quba) = $this->create_finalquiz_with_questions(true, false);
        ...
        $result = mod_finalquiz_external::view_attempt($attempt->id, 0);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::view_attempt_returns(), $result);
        $this->assertTrue($result['status']);
        ...
        // Checking that the event contains the expected values.
        $this->assertInstanceOf('\mod_finalquiz\event\attempt_viewed', $event);
        $this->assertEquals($context, $event->get_context());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());

        // Now, force the quiz with FINALQUIZ_NAVMETHOD_SEQ (sequencial) navigation method.
        $DB->set_field('finalquiz', 'navmethod', FINALQUIZ_NAVMETHOD_SEQ, array('id' => $quiz->id));
        // Quiz requiring preflightdata.
        $DB->set_field('finalquiz', 'password', 'abcdef', array('id' => $quiz->id));
        $preflightdata = array(array("name" => "quizpassword", "value" => 'abcdef'));

        // See next page.
        $result = mod_finalquiz_external::view_attempt($attempt->id, 1, $preflightdata);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::view_attempt_returns(), $result);
        $this->assertTrue($result['status']);
        ...
        try {
            mod_finalquiz_external::view_attempt($attempt->id, 0);
    ...
    public function test_view_attempt_summary() {
        ...
        $result = mod_finalquiz_external::view_attempt_summary($attempt->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::view_attempt_summary_returns(), $result);
        $this->assertTrue($result['status']);
        ...
        // Checking that the event contains the expected values.
        $this->assertInstanceOf('\mod_finalquiz\event\attempt_summary_viewed', $event);
        $this->assertEquals($context, $event->get_context());
        $moodlequiz = new \moodle_url('/mod/finalquiz/summary.php', array('attempt' => $attempt->id));
        $this->assertEquals($moodlequiz, $event->get_url());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());
        ...
        $result = mod_finalquiz_external::view_attempt_summary($attempt->id, $preflightdata);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::view_attempt_summary_returns(), $result);
        $this->assertTrue($result['status']);
    ...
    public function test_view_attempt_review() {
        ...
        $result = mod_finalquiz_external::view_attempt_review($attempt->id, 0);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::view_attempt_review_returns(), $result);
        $this->assertTrue($result['status']);
        ...
        // Checking that the event contains the expected values.
        $this->assertInstanceOf('\mod_finalquiz\event\attempt_reviewed', $event);
        $this->assertEquals($context, $event->get_context());
        $moodlequiz = new \moodle_url('/mod/finalquiz/review.php', array('attempt' => $attempt->id));
        $this->assertEquals($moodlequiz, $event->get_url());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());
    ...
    /**
     * Test get_finalquiz_feedback_for_grade
     */
    public function test_get_finalquiz_feedback_for_grade() {
        global $DB;
        ...
        $result = mod_finalquiz_external::get_finalquiz_feedback_for_grade($this->quiz->id, 50);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_finalquiz_feedback_for_grade_returns(), $result);
        ...
        $result = mod_finalquiz_external::get_finalquiz_feedback_for_grade($this->quiz->id, 30);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_finalquiz_feedback_for_grade_returns(), $result);
        $this->assertEquals('Feedback text 2', $result['feedbacktext']);
        $this->assertEquals(FORMAT_HTML, $result['feedbacktextformat']);

        $result = mod_finalquiz_external::get_finalquiz_feedback_for_grade($this->quiz->id, 10);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_finalquiz_feedback_for_grade_returns(), $result);
    ...
    /**
     * Test get_finalquiz_access_information
     */
    public function test_get_finalquiz_access_information() {
        global $DB;
        ...
        $result = mod_finalquiz_external::get_finalquiz_access_information($quiz->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_finalquiz_access_information_returns(), $result);
        ...
        $expected = array(
            ...
            'activerulenames' => ['finalquizaccess_openclosedate'],
    ...
    public function test_get_attempt_access_information() {
        ...
        // Default restrictions (none).
        $result = mod_finalquiz_external::get_attempt_access_information($quiz->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_attempt_access_information_returns(), $result);
        ...
        $result = mod_finalquiz_external::get_attempt_access_information($quiz->id, $attempt->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_attempt_access_information_returns(), $result);
        ...
        $this->assertEquals(get_string('nomoreattempts', 'finalquiz'), $result['preventnewattemptreasons'][0]);

    }

    /**
     * Test get_finalquiz_required_qtypes
     */
    public function test_get_finalquiz_required_qtypes() {
        $this->setAdminUser();
        ...
        $result = mod_finalquiz_external::get_finalquiz_required_qtypes($quiz->id);
        $result = external_api::clean_returnvalue(mod_finalquiz_external::get_finalquiz_required_qtypes_returns(), $result);
