...
$baseurl = new moodle_url('/mod/finalquiz/reviewquestion.php',
...
$PAGE->set_title(get_string('reviewofquestion', 'finalquiz', array(
...
if ($attemptobj->is_own_attempt()) {
    if (!$attemptobj->is_finished()) {
        echo $output->review_question_not_allowed($attemptobj, get_string('cannotreviewopen', 'finalquiz'));
        die();
...
// Other attempts at the final quiz.
