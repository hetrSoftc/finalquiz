...
require_once($CFG->dirroot . '/mod/finalquiz/report/overview/report.php');
...
class quiz_overview_report_testcase extends advanced_testcase {
    ...
    public function test_report_sql($isdownloading) {
        ...
        $quiz = $quizgenerator->create_instance(array('course' => $course->id,
                'grademethod' => FINALQUIZ_GRADEHIGHEST, 'grade' => 100.0, 'sumgrades' => 10.0,
                'attempts' => 10));
        ...
        quiz_add_finalquiz_question($q->id, $quiz, 0 , 10);
        ...
        $reportoptions->attempts = finalquiz_attempts_report::ENROLLED_ALL;
        ...
        $table->define_baseurl(new moodle_url('/mod/finalquiz/report.php'));
        $table->setup();
