 ...
 */
function xmldb_finalquiz_overview_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2018061800) {
        ...
        upgrade_plugin_savepoint(true, 2018061800, 'finalquiz', 'overview');
    }
    ...
    if ($oldversion < 2018061801) {
        ...
        // Overview savepoint reached.
        upgrade_plugin_savepoint(true, 2018061801, 'finalquiz', 'overview');
    }
