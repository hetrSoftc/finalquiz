...
require_once($CFG->dirroot . '/mod/finalquiz/report/attemptsreport_options.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_overview_options extends mod_finalfinalquiz_attempts_report_options {
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/finalquiz:regrade', 'mod/finalquiz:deleteattempts'), context_module::instance($this->cm->id))
                && ($this->attempts != finalquiz_attempts_report::ENROLLED_WITHOUT);
    }
}
