 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_responses_options extends mod_finalfinalquiz_attempts_report_options {
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_capability('mod/finalquiz:deleteattempts', context_module::instance($this->cm->id))
