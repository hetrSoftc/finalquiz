...
require_once($CFG->dirroot . '/mod/finalquiz/report/responses/responses_options.php');
require_once($CFG->dirroot . '/mod/finalquiz/report/responses/responses_form.php');
require_once($CFG->dirroot . '/mod/finalquiz/report/responses/last_responses_table.php');
require_once($CFG->dirroot . '/mod/finalquiz/report/responses/first_or_all_responses_table.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_responses_report extends finalquiz_attempts_report {
