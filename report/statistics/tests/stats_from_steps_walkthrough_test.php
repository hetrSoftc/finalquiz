...
global $CFG;
require_once($CFG->dirroot . '/mod/finalquiz/tests/attempt_walkthrough_from_csv_test.php');
require_once($CFG->dirroot . '/mod/finalquiz/report/default.php');
require_once($CFG->dirroot . '/mod/finalquiz/report/statistics/report.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_report_statistics_from_steps_testcase extends mod_finalquiz_attempt_walkthrough_from_csv_testcase {
    ...
    public function test_walkthrough_from_csv($quizsettings, $csvdata) {
        ...
        $this->create_finalquiz_simulate_attempts_and_check_results($quizsettings, $csvdata);

        $whichattempts = FINALQUIZ_GRADEAVERAGE; // All attempts.
        ...
        if ($quizsettings['testnumber'] === '00') {
            $this->check_variants_count_for_finalquiz_00($questions, $questionstats, $whichtries, $qubaids);
            $this->check_finalquiz_stats_for_finalquiz_00($quizstats);
        }
    }
     ...
     * @param $qubaids
     */
    protected function check_variants_count_for_finalquiz_00($questions, $questionstats, $whichtries, $qubaids) {
     ...
     * @param $quizstats
     */
    protected function check_finalquiz_stats_for_finalquiz_00($quizstats) {
