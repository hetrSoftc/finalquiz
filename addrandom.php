...
/**
 * Fallback page of /mod/finalquiz/edit.php add random question dialog,
...
list($thispageurl, $contexts, $cmid, $cm, $quiz, $pagevars) =
        question_edit_setup('editq', '/mod/finalquiz/addrandom.php', true);
...
if ($returnurl) {
    ...
    $returnurl = new moodle_url('/mod/finalquiz/edit.php', array('cmid' => $cmid));
}
if ($scrollpos) {
...
$mform = new finalquiz_add_random_form(new moodle_url('/mod/finalquiz/addrandom.php'),
...
if ($data = $mform->get_data()) {
    ...
    finalquiz_add_random_questions($quiz, $addonpage, $categoryid, $data->numbertoadd, $includesubcategories, $tagids);
...
// Setup $PAGE.
$streditingquiz = get_string('editinga', 'moodle', get_string('modulename', 'finalquiz'));
...
echo $OUTPUT->heading(get_string('addrandomquestiontoquiz', 'finalquiz', $quizname), 2);
$mform->display();
echo $OUTPUT->footer();
