...
$functions = array(
    ...
    'mod_finalquiz_get_quizzes_by_courses' => array(
        ...
        'type'          => 'read',
        'capabilities'  => 'mod/finalquiz:view',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),

    'mod_finalquiz_view_quiz' => array(
        'classname'     => 'mod_finalquiz_external',
        'methodname'    => 'view_finalquiz',
    ...
    'mod_finalquiz_get_user_attempts' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_get_user_best_grade' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_get_combined_review_options' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_start_attempt' => array(
        'classname'     => 'mod_finalquiz_external',
        'methodname'    => 'start_attempt',
        'description'   => 'Starts a new attempt at a quiz.',
        'type'          => 'write',
        'capabilities'  => 'mod/finalquiz:attempt',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),

    'mod_finalquiz_get_attempt_data' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_get_attempt_summary' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_save_attempt' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_process_attempt' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_get_attempt_review' => array(
        'classname'     => 'mod_finalquiz_external',
        ...
        'type'          => 'read',
        'capabilities'  => 'mod/finalquiz:reviewmyattempts',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),

    'mod_finalquiz_view_attempt' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_view_attempt_summary' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_view_attempt_review' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_get_finalquiz_feedback_for_grade' => array(
        'classname'     => 'mod_finalquiz_external',
        'methodname'    => 'get_finalquiz_feedback_for_grade',
    ...
    'mod_finalquiz_get_finalquiz_access_information' => array(
        'classname'     => 'mod_finalquiz_external',
        'methodname'    => 'get_finalquiz_access_information',
    ...
    'mod_finalquiz_get_attempt_access_information' => array(
        'classname'     => 'mod_finalquiz_external',
    ...
    'mod_finalquiz_get_finalquiz_required_qtypes' => array(
        'classname'     => 'mod_finalquiz_external',
        'methodname'    => 'get_finalquiz_required_qtypes',
